            ...
            <div class="span12">    
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        <form class="" action="{{route('search_warehouse_report')}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div  style="display: inline-block; vertical-align: middle;">
                                <label>Status :</label>
                                <select name="status">
                                    <option value="0" <?php if($status == ''){ echo 'selected'; } ?>>All Status</option>
                                    <option value="entry" <?php if($status == 'entry'){ echo 'selected';} ?>>Entry</option>
                                    <option value="delivered" <?php if($status == 'delivered'){ echo 'selected';} ?>>Delivered</option>
                                    <option value="back" <?php if($status == 'back'){ echo 'selected';} ?>>Back</option>
