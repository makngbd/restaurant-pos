...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                <a href="{{route('damage_items')}}" class="btn btn-info"><i class="fa fa-chain-broken"></i> Damage Items</a>
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="fa fa-chain-broken"></i> </span>
                        <h5>Add Damage Item</h5>
                    </div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="{{route('save_damage_item')}}" method="post" class="form-horizontal">
                            {{csrf_field()}}
                            ...
                            <div class="control-group">
                                <label class="control-label">Damage From</label>
                                <div class="controls">
                                    <select name="damage_from" id="item" class="span3" required="">
