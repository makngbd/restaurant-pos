...
<div id="content">
    <div id="content-header">
        ...
        <h1>Add Kitchen Stock</h1>
    </div>
    <div class="container-fluid">
        <hr>
        <div class="row-fluid">
            <div class="span12">
                <a href="{{route('kitchen_stock')}}" class="btn btn-info"><i class="fa fa-cutlery"></i> Kitchen Stock</a>
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="fa fa-cutlery"></i> </span>
                        <h5>Add Kitchen Stock</h5>
                    </div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="{{route('save_kitchen_stock')}}" method="post" class="form-horizontal">
                            {{csrf_field()}}
